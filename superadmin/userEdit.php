...
<?php
include "../core/fetch_user_data_Admin.php";
?>
                ...
                <div class="card bg-light-info shadow-none position-relative overflow-hidden">
                    <div class="card-body px-4 py-3">
                        <div class="row align-items-center">
                            <div class="col-9">
                                <h4 class="fw-semibold mb-8">Admin User Edit</h4>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form id="userinfoform" class="needs-validation row" action="../core/save_user_details_Admin.php" method="post" enctype="multipart/form-data" novalidate>
                                    <div class="col-md-4 form-floating mb-3">
                                        <input type="text" name="user_id" value="<?= $_POST['userID'] ?>" hidden />
                                        <input type="text" name="status" value="<?php echo htmlspecialchars($userData['status']); ?>" hidden />
                                    ...
                                    <div class="col-md-7 form-floating mb-3">
                                        <input type="email" name="email" value="<?php echo htmlspecialchars($userData['email']); ?>" class="form-control" placeholder="Email Address" required />
