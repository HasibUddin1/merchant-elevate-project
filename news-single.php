...
<body>
    ...
    <div class="news-single-page">
        ...
        <section class="blog-details ptb-120">
            ...
            <div class="container">
                <!--cat subscribe start-->
                <div class="bg-dark ptb-60 px-5 mt-100 position-relative overflow-hidden rounded-custom" style="
                        ...
                        <div class="col-lg-8 col-md-9">
                            <div class="subscribe-info-wrap text-center position-relative z-2">
                                ...
                                <ul class="nav justify-content-center subscribe-feature-list mt-3">
                                    <li class="nav-item">
                                        <span><i class="far fa-dot-circle text-primary me-2"></i>Don’t worry we won’t send you spam</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="row align-items-center justify-content-between">
                    ...
                    <div class="col-lg-7 col-md-12">
                        <div class="text-start text-lg-end mb-4 mb-lg-0 mb-xl-0">
                            <a href="news" class="btn btn-primary">View All Article</a>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="single-article rounded-custom mb-4 mb-lg-0">
                            <a href="news-single" class="article-img">
